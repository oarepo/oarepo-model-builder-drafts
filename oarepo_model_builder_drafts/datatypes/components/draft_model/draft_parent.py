...
class DraftParentComponent(DataTypeComponent):
    ...
    def before_model_prepare(self, datatype, *, context, **kwargs):
        ...
        draft_parent_record.setdefault("base-classes", ["invenio_drafts_resources.records.api.ParentRecord"])
        draft_parent_record.setdefault(
        ...
        draft_parent_record_state.setdefault( #todo "invenio_db.db.Model",
            "base-classes", ["invenio_db.db{db.Model}", "invenio_drafts_resources.records.ParentRecordStateMixin"]
        )
        draft_parent_record_state.setdefault(
            "imports",
            [
        ...
        draft_parent_record_metadata.setdefault( #todo "invenio_db.db.Model",
            "base-classes", [ "invenio_db.db{db.Model}","invenio_records.models.RecordMetadataBase"]
        )
        draft_parent_record_metadata.setdefault(
            "imports",
            [
